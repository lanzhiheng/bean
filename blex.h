...
typedef enum RESERVED {
  ...
  TK_LOGIC_XOR, TK_MOD,
  TK_COLON, TK_COMMA, TK_SEMI, TK_BANG,
  ...
  TK_IF, TK_SELF, TK_IN, TK_TYPE_OF, TK_GLOBAL, TK_NIL, TK_NOT, TK_OR,
  TK_RETURN, TK_TRUE, TK_DO, TK_WHILE,
  /* other terminal symbols */
  TK_EQ, TK_ASSIGN, TK_GE, TK_GT, TK_LE, TK_LT, TK_NE,
  TK_SHL, TK_SHR,
  TK_EOS,
  TK_NUM, TK_NAME, TK_STRING, TK_REGEX
} TokenType;
