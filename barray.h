...
int primitive_Array_shift(bean_State * B, TValue * this, TValue * args, int argc, TValue * context UNUSED, TValue ** ret);
int primitive_Array_pop(bean_State * B, TValue * this, TValue * args, int argc, TValue * context UNUSED, TValue ** ret);
int primitive_Array_push(bean_State * B, TValue * this, TValue * args UNUSED, int argc, TValue * context UNUSED, TValue ** ret);
